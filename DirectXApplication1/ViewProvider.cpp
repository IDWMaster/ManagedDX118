...
{
    if (entryPoint == "DirectXApplication1.App")
    {
        m_activationEntryPoint = ActivationEntryPoint::DirectXApplication1;
    }
}
...
{
    if (m_activationEntryPoint == ActivationEntryPoint::DirectXApplication1)
    {
